Need to think about proper test organization for Dedalus. Familiar int/out like tests are not applicable here, since expected result may come eventually, asynchronously.
